...
export enum ToastKeys {
  ...
  PASSWORD_CHANGED = 'TOAST.PASSWORD_CHANGED',
...
export enum DriverKeys {
  ...
  ONGOING = 'DRIVER.ONGOING',
  ONGOING_PROMPT = 'DRIVER.ONGOING_PROMPT',
  PARKING_TICKETS = 'DRIVER.PARKING_TICKETS',
  TIME_OF_ENTRY = 'DRIVER.TIME_OF_ENTRY',
  VALID_TO = 'DRIVER.VALID_TO',
  TIME_OF_LEAVE = 'DRIVER.TIME_OF_LEAVE',
  RETURNED = 'DRIVER.RETURNED',
}

export enum ClerkKeys {
  ISSUE_PARKING_TICKET = 'CLERK.ISSUE_PARKING_TICKET',
  RETURN_PARKING_TICKET = 'CLERK.RETURN_PARKING_TICKET',
  FIND_CAR_BY_LICENSE_PLATE = 'CLERK.FIND_CAR_BY_LICENSE_PLATE',
  ENTERING_INSTRUCTION = 'CLERK.ENTERING_INSTRUCTION',
  LEAVING_INSTRUCTION = 'CLERK.LEAVING_INSTRUCTION',
  LICENSE_PLATE = 'CLERK.LICENSE_PLATE',
  SEARCH_RESERVATIONS = 'CLERK.SEARCH_RESERVATIONS',
  ENTER_LICENSE_PLATE_NUMBER = 'CLERK.ENTER_LICENSE_PLATE_NUMBER',
  CONFIRM_TICKET_ISSUE = 'CLERK.CONFIRM_TICKET_ISSUE',
  CONFIRM_TICKET_ISSUE_QUESTION = 'CLERK.CONFIRM_TICKET_ISSUE_QUESTION',
  CONFIRM_TICKET_RETURN = 'CLERK.CONFIRM_TICKET_RETURN',
  CONFIRM_TICKET_RETURN_QUESTION = 'CLERK.CONFIRM_TICKET_RETURN_QUESTION',
}
export enum TableKeys {
  ...
  TIME_OF_OPERATION = 'TABLE_KEYS.TIME_OF_OPERATION',
}
